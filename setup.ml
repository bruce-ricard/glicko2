...
(* OASIS_START *)
(* DO NOT EDIT (digest: fb64c0910265c7041a2302469a945b1e) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "example";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "glicko2"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
     ...
     oasis_digest = Some "\006\193V\131\243\031L\174\23734\215\0278\147\136";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
